...
S {}
E {}
N 820 -440 880 -440 { lab=out_clkb}
N 820 -620 880 -620 { lab=out_clk}
N 620 -500 620 -440 { lab=stor_node_b}
N 620 -620 620 -580 { lab=stor_node}
N 700 -620 700 -580 { lab=stor_node}
N 700 -500 700 -440 { lab=stor_node_b}
N 580 -620 740 -620 { lab=stor_node}
N 580 -440 740 -440 { lab=stor_node_b}
N 180 -440 280 -440 { lab=in_clk}
N 420 -500 420 -440 { lab=#net1}
N 420 -620 420 -580 { lab=#net2}
N 420 -620 500 -620 { lab=#net2}
N 360 -440 500 -440 { lab=#net1}
N 180 -520 220 -520 { lab=vdd}
N 180 -480 220 -480 { lab=vss}
C {devices/opin.sym} 870 -620 0 0 {name=p3 lab=out_clk}
C {devices/opin.sym} 870 -440 0 0 {name=p4 lab=out_clkb}
...
C {devices/ipin.sym} 190 -440 0 0 {name=p5 lab=in_clk}
C {sky130_stdcells/inv_2.sym} 320 -440 0 0 {name=x1 VGND=vss VNB=vss VPB=vdd VPWR=vdd prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/inv_2.sym} 420 -540 3 0 {name=x2 VGND=vss VNB=vss VPB=vdd VPWR=vdd prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/inv_1.sym} 780 -620 0 0 {name=x4 VGND=vss VNB=vss VPB=vdd VPWR=vdd prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/inv_1.sym} 780 -440 0 0 {name=x6 VGND=vss VNB=vss VPB=vdd VPWR=vdd prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/inv_2.sym} 620 -540 3 0 {name=x7 VGND=vss VNB=vss VPB=vdd VPWR=vdd prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/inv_2.sym} 700 -540 1 0 {name=x9 VGND=vss VNB=vss VPB=vdd VPWR=vdd prefix=sky130_fd_sc_hd__ }
C {lab_wire.sym} 700 -620 0 0 {name=l1 sig_type=std_logic lab=stor_node}
C {lab_wire.sym} 700 -440 0 0 {name=l2 sig_type=std_logic lab=stor_node_b}
C {sky130_stdcells/inv_1.sym} 540 -620 0 0 {name=x3 VGND=vss VNB=vss VPB=vdd VPWR=vdd prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/inv_1.sym} 540 -440 0 0 {name=x5 VGND=vss VNB=vss VPB=vdd VPWR=vdd prefix=sky130_fd_sc_hd__ }
C {lab_wire.sym} 220 -520 0 0 {name=l3 sig_type=std_logic lab=vdd}
C {lab_wire.sym} 220 -480 0 0 {name=l4 sig_type=std_logic lab=vss}
C {devices/noconn.sym} 220 -520 0 1 {name=l5}
C {devices/noconn.sym} 220 -480 0 1 {name=l6}
