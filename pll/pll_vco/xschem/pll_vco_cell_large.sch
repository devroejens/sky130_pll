...
C {sky130_fd_pr/cap_var_lvt.sym} 790 -440 3 0 {name=C1 model=cap_var_lvt W=70 L=4 VM=3 spiceprefix=X}
C {sky130_fd_pr/cap_var_lvt.sym} 1010 -440 1 1 {name=C2 model=cap_var_lvt W=70 L=4 VM=3 spiceprefix=X}
